...
const RefundPage: React.FC = () => (
  <div className="max-w-3xl mx-auto py-12 px-4">
    ...
    <div className="space-y-5 text-gray-300">
      ...
      <p>
        To request a refund review, contact <a className="text-blue-400" href="mailto:futbott97@gmail.com">futbott97@gmail.com</a> with your order information and an explanation of the issue.
      </p>
    </div>
  </div>
);
